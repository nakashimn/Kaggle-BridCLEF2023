config = {
    ...
    "group": "group",
    "experiment_name": "birdclef2023-pretrain-v0",
    "path": {
        "traindata": "/workspace/kaggle/input/pretrain_dataset_5s_v0/train_audio/",
        "trainmeta": None,
        "testdata": None,
        "preddata": None,
        "temporal_dir": "../tmp/artifacts/",
        "model_dir": "/kaggle/input/birdclef2023-pretrain-v0/",
        "start_checkpoint": "/kaggle/input/birdclef2023-pretrain-v0/best_loss-v2.ckpt",
    },
    "modelname": "best_loss",
    "sampling_rate": 32000,
    "chunk_sec": 5,
...
config["model"] = {
    ...
    "save_directory": "/workspace/data/model/birdclef2023_pretrained/"
}
