config = {
    ...
    "path": {
        "traindata": "/kaggle/input/birdclef-2023-modified/train_audio/",
        "trainmeta": "/kaggle/input/birdclef-2023-modified/train_metadata.csv",
        "testdata": "/kaggle/input/birdclef-2023-modified/train_audio/",
